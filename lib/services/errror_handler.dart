...
import 'package:terf/services/interseptor.dart';
import '../screens/home_page/model/nearby_turf_model.dart';

class CommenErrorHandler extends ChangeNotifier {
  getErrorHandler(context, apiKey) async {
    try {
